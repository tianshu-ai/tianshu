    ...
    <aside className="flex h-full w-64 flex-shrink-0 flex-col border-r border-border-subtle bg-bg-elevated">
      ...
      <div className="space-y-1 px-2 pt-2">
        ...
        <div className="flex cursor-pointer items-center gap-2 rounded-lg bg-bg-raised px-3 py-2 text-fg-default">
          <img src="/classical/tianshu-avatar.png" alt="" className="h-6 w-6 rounded-full object-cover flex-shrink-0" />
...
function ChangePasswordModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        className="w-80 rounded-xl border border-border-default bg-bg-surface p-5 shadow-xl"
      ...
      >
        ...
        {done ? (
          ...
          <div className="flex flex-col gap-3">
            {error && (
              <div className="rounded-md border border-rose-700/50 bg-rose-950/40 px-3 py-1.5 text-xs text-danger">
                {error}
              </div>
            )}
